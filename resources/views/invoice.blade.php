...
<body class="font-poppins">
    <div style="height: 200px">
        <div class="w-3\/4 float-left">
            <img src="{{ public_path('images/main/ace-cars-250.png') }}">
            <p class="text-sm" style="line-height: 0.5rem">Ace Tyres</p>
            <p class="text-sm" style="line-height: 0.5rem">0800 123123</p>
            <p class="text-sm" style="line-height: 0.5rem">info@acetyres.co.uk</p>
            <p class="text-sm" style="line-height: 0.5rem">www.acetyres.co.uk</p>
        </div>
    ...
    <div class="footer">
        <p class="m-0 text-xs text-gray-600">&copy; 2024, Ace Tyres</p>
    </div>
    ...
    <div class="footer">
        <p class="m-0 text-xs text-gray-600">&copy; 2022, Ace Tyres</p>
    </div>
</body>
</html>
