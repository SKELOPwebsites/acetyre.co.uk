<template>
    <Head>
        <title>Order Summary | Ace Tyres</title>
        <link rel="canonical" href="https://acetyres.co.uk/checkout">
    </Head>

    <div class="container py-10 border-x border-stone-700 font-montserrat">
                ...
                <div class="mb-6 mt-12">
                    ...
                    <div class="relative min-h-[175px] grid grid-cols-12 gap-x-4 py-5 border-b">
                        ...
                        <div class="sm:col-span-2 col-span-3 flex items-center">
                            <img class="w-full" src="/images/tyres/timeslot.webp" alt="timeslot">
                        </div>
