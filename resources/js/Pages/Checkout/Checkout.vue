<template>
    <Head>
        <title>Checkout | Ace Tyres</title>
    ...
    <div class="container border-x border-stone-700 font-montserrat">
        <div class="py-12 px-4 bg-stone-700">
            <div class="relative grid grid-cols-12 xl:gap-x-6 gap-y-4">
                ...
                <div class="xl:col-span-9 col-span-12 relative">
                    ...
                    <div class="bg-white rounded-lg border border-gray-300 shadow-lg">
                        ...
                        <div class="2xl:px-24 sm:px-4 px-3 pb-12 pt-6">
                    ...
                    <div class="bg-white rounded-lg border border-gray-300 shadow-lg mt-4">
                        <div class="pb-12 2xl:px-24 sm:px-4 px-3 pt-6">
...
onMounted(async () => {
    stripe.value = await loadStripe(import.meta.env.VITE_MIX_STRIPE_KEY);
