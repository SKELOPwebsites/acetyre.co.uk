<template>
    <Head>
        <title>Checkout - Fitting Details | Ace Tyres</title>
        <link rel="canonical" href="https://acetyres.co.uk/checkout">
    </Head>

    <div class="container border-x border-stone-700 font-montserrat">
        <div class="py-12 px-4 bg-stone-700">
            <div class="relative grid grid-cols-12 xl:gap-x-6 gap-y-4">
                <div class="col-span-12">
                    <div class="xl:w-3/4 w-full">
                        <div class="w-[250px] mx-auto flex text-xs flex-row justify-between items-center text-stone-500">
                            <span class="flex items-center text-stone-400 font-bold">
                                Fitting Details
                            </span>
                ...
                <div class="xl:col-span-9 col-span-12 space-y-4">
                    <div class="bg-white 2xl:px-24 sm:px-4 px-3 py-12 rounded-lg border border-gray-300 shadow-lg">
                    ...
                    <div class="bg-white 2xl:px-24 sm:px-4 px-3 py-12 rounded-lg border border-gray-300 shadow-lg">
                        ...
                        <div v-show="showTimeslotError" class="flex items-center justify-between bg-red-400 w-full py-3 px-4 mb-4 mt-6 rounded-lg">
                            <span class="text-sm text-white" v-text="$page.props.flash.errors.timeslot"></span>
                ...
                <div class="xl:col-span-3 col-span-12 space-y-4">
