<template>
    <div class="relative min-h-[175px] grid grid-cols-12 gap-x-4 py-5 border-b">
        ...
        <div class="col-span-12 md:hidden flex pb-2">
            <span class="sm:text-base text-xs text-ellipsis whitespace-nowrap overflow-hidden pr-4">{{ tyre.brand }} {{ tyre.model }} {{ tyre.width }}/{{ tyre.profile }} R{{ tyre.rim }} {{ tyre.speed }}</span>
        </div>
        <div class="sm:col-span-2 col-span-4 flex items-center">
        ...
        <div class="sm:col-span-10 col-span-8 flex flex-col">
            ...
            <div class="mt-auto flex items-center justify-between">
                <div class="flex sm:flex-row flex-col sm:items-center items-start space-x-2">
                    ...
                    <span class="sm:block hidden text-sm text-gray-400">&#10072</span>
