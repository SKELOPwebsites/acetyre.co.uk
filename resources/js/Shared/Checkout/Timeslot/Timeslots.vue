<template>
    ...
    <div v-if="timeslots" :class="class">
        ...
        <template v-if="timeslots">
            <TimeslotsPC @selectTimeslot="selectTimeslot" :timeslots="timeslots" class="sm:block hidden"></TimeslotsPC>
            <TimeslotsMob @selectTimeslot="selectTimeslot" :timeslots="timeslots" class="sm:hidden block"></TimeslotsMob>
        </template>
    </div>
</template>
